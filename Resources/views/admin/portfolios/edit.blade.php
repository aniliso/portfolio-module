...
@section('content-header')
    <h1>
        {{ trans('portfolio::portfolios.title.edit portfolio') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.portfolio.portfolio.index') }}">{{ trans('portfolio::portfolios.title.portfolios') }}</a></li>
        <li class="active">{{ trans('portfolio::portfolios.title.edit portfolio') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.portfolio.portfolio.update', $portfolio->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-10">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group{{ $errors->has("start_at") ? ' has-error' : '' }}">
                        ...
                        <div class='input-group date' id='start_at'>
                            <input type="text" class="form-control" name="start_at" value="{{ old('start_at', $portfolio->start_at->format('d.m.Y')) }}" />
                    ...
                    <div class="form-group{{ $errors->has("end_at") ? ' has-error' : '' }}">
                        ...
                        <div class='input-group date' id='end_at'>
                            <input type="text" class="form-control" name="end_at" value="{{ old('start_at', $portfolio->end_at->format('d.m.Y')) }}" />
                            <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                        </div>
                        {!! $errors->first("end_at", '<span class="help-block">:message</span>') !!}
                    </div>

                    {!! Form::normalInput('ordering', trans('portfolio::brands.form.ordering'), $errors, $portfolio) !!}

                    {!! Form::normalCheckbox('status', trans('portfolio::brands.form.status'), $errors, $portfolio) !!}
                </div>
            </div>
            <div class="box">
                <div class="box-body">
                    @tags('asgardcms/portfolio', $portfolio)
